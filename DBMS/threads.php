...
<body>
		...
		<div class="modal-body">
			<form class="form-horizontal">
				...
				<div class="control-group">
					...
					<div class="controls">
						<div class="date" id="dp1" data-date=" " data-date-format="yyyy-mm-dd">
				...
				<div class="control-group">
					...
					<div class="controls">
						<div class="date" id="dp2" data-date=" " data-date-format="yyyy-mm-dd">
	...
	<div id="myGroupModalContainer" style="display: none;" >
		<div id="myGroupModal">
			...
			<div id="grpReqMembersLbl">Select group members<br/><span id="grpNotice">Please add Prof and AI as group members or else group request might be rejected</span></div>
			<div id="mbody">
